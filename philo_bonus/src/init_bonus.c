...
/*   Updated: 2024/06/09 16:43:22 by belguabd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_data(t_data *data, char *av[])
{
	...
	data->time_to_die = ft_atoi_parsing(av[2]);
	data->time_to_eat = ft_atoi_parsing(av[3]);
	data->time_to_sleep = ft_atoi_parsing(av[4]);
	if (av[5])
		data->must_eat_count = ft_atoi_parsing(av[5]);
	else
